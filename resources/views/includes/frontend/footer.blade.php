        ...
        <div class="uk-container">
            <div class="uk-grid uk-flex uk-flex-middle">
                <div class="uk-width-2-3@m uk-text-small">
                    ...
                    <p class="copyright-text"><span> © <?php echo date('Y'); ?> {{ $footer_copyright }}: </span></p>
                </div>
...
<footer class="bg-light pb-4 in-avo-footer">
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 gy-4 gy-lg-0">
            ...
            <div class="col-md-12 col-lg-12 text-center small mt-4">
                ...
                <p class="copyright-text">Copyright © <?php echo date('Y'); ?> {{ $footer_copyright }}</p>
            </div>
        </div>
    </div>
</footer>
